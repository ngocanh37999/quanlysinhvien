    ...
    <>
      <div className='mt-16 py-10'>
        ...
        <div className='flex items-center justify-center'>
          <a href='https://tailwindcss.com/' target='_blank' rel='noreferrer' title='Tailwindcss' className='mr-4'>
          ...
          <a href='https://nextjs.org/' target='_blank' rel='noreferrer' title='Nextjs' className='mr-4'>
